  ...
  <div id="wrapper">
    ...
    <nav id = "sidebar" v-show = "$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display: none;">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/employee">List Employee</router-link>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/supplier">List Supplier</router-link>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/category">List Category</router-link>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/product">List Product</router-link>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap4" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/expense">List Expense</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap6" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/customer">List Customer</router-link>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/salary">List Salary</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/given-salary">Report 1</router-link>
            <router-link class="collapse-item" to="/salary">Report 2</router-link>
          </div>
        </div>
      </li>
