...
let editsuppler = require('./components/supplier/edit.vue').default;
...
export const routes = [
  ...
  { path: '/edit-supplier/:id', component: editsuppler, name: 'edit-supplier'},
  ...
  { path: '/edit-customer', component: editcustomer, name:'edit-customer'},
